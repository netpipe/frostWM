...
AUTOMAKE_VERSION=`echo "$AUTOMAKE_STRING" | sed 's/^.*\([0-9][0-9]*\)\.\([0-9][0-9]*\)\(-p\([0-9][0-9]*\)\)* *$/\1,0\2,00\4/;s/^\([0-9]*\),0*\([0-9][0-9]\),0*\([0-9][0-9]\)$/\1\2\3/'`
if test "$AUTOMAKE_VERSION" -lt 10500 ; then
