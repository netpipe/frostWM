...
*/
    ...
    if (found)
    {
    	if (!srs_gs_speaker_update (found->speaker, voice))
	{
	    g_hash_table_remove (srs_voices, voice->id);
	    rv = FALSE;
	}
    }
    else
    {
	SRSGSSpeaker *speaker = srs_gs_speaker_new (voice);
	if (speaker)
	{
	    found = srs_voice_new ();
...
static struct
{
	...
	{'a',	"a",		N_("Phonetic|Alpha")	},
	{'b',	"b",		N_("Phonetic|Bravo")	},
	{'c',	"c",		N_("Phonetic|Charlie")	},
	{'d',	"d",		N_("Phonetic|Delta")	},
	{'e',	"e",		N_("Phonetic|Echo")	},
	{'f',	"f",		N_("Phonetic|Foxtrot")	},
	{'g',	"g",		N_("Phonetic|Golf")	},
	{'h',	"h",		N_("Phonetic|Hotel")	},
	{'i',	"i",		N_("Phonetic|India")	},
	{'j',	"j",		N_("Phonetic|Juliet")	},
	{'k',	"k",		N_("Phonetic|Kilo")	},
	{'l',	"l",		N_("Phonetic|Lima")	},
	{'m',	"m",		N_("Phonetic|Mike")	},
	{'n',	"n",		N_("Phonetic|November")	},
	{'o',	"o",		N_("Phonetic|Oscar")	},
	{'p',	"p",		N_("Phonetic|Papa")	},
	{'q',	"q",		N_("Phonetic|Quebec")	},
	{'r',	"r",		N_("Phonetic|Romeo")	},
	{'s',	"s",		N_("Phonetic|Sierra")	},
	{'t',	"t",		N_("Phonetic|Tango")	},
	{'u',	"u",		N_("Phonetic|Uniform")	},
	{'v',	"v",		N_("Phonetic|Victor")	},
	{'w',	"w",		N_("Phonetic|Whiskey")	},
	{'x',	"x",		N_("Phonetic|Xray")	},
	{'y',	"y",		N_("Phonetic|Yankee")	},
	{'z',	"z",		N_("Phonetic|Zulu")	},
	{' ',	N_("space"),	N_("space")	},
	{'\t',	N_("tab"),	N_("tab")	},
	...
	for (i = 0, crt = tout->text; *crt; i++, crt = g_utf8_next_char (crt))
	{
		...
		g_string_append (text,
			    tout->spelling == SRS_SPELLING_CHAR ? 
				    ...
				    Q_(srs_sp_spell_table[index].military));
	    else
...
gboolean
srs_sp_init (SRSMarkersCallback callback, SRSResetCallback reset_callback)
{
    sru_assert (callback);
    ...
    return srs_gs_init (srs_sp_clb, reset_callback);
}
