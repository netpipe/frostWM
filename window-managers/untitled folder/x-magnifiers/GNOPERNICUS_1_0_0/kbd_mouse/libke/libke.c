...
ke_return_keystring (gint keyID)
{
	...
	case XK_Super_L:rv = g_strdup ("Super_L");break;
	case XK_Super_R:rv = g_strdup ("Super_R");break;
	case XK_Hyper_L:rv = g_strdup ("Hyper_L");break;
	case XK_Hyper_R:rv = g_strdup ("Hyper_R");break;
	case XK_Menu:rv = g_strdup ("Menu");break;	
        default:
    	    rv = NULL;
    }
