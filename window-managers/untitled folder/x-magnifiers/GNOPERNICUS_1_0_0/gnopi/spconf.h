...
gboolean 	spconf_key_is_valid (gchar *path);
...
const SpeechVoice*  spconf_driver_list_get_speech_voice (SpeechDriverListType *driver_list,
				    			 const gchar *driver_name,
			    	    			 const gchar *voice_name_descr);
const gchar*	    spconf_voice_list_get_default_voice (GSList *voices, gchar *voice_name);
const SpeechDriver* spconf_driver_list_get_default_driver (SpeechDriverListType *driver_list,
							   const gchar *driver_name);
