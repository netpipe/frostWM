...
/* FIXME the next line will be available only starting with gtk+ 2.6 */
    /* gtk_window_set_default_icon_name ("gnopernicus"); */
    gtk_window_set_default_icon_from_file (GNOPERNICUS_ICON, NULL);
